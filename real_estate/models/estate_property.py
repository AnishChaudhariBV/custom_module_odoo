...
class Estateproperty(models.Model):
    ...
    date_availability = fields.Datetime('Date Availability', default=datetime.now() + relativedelta(months=3), copy=False)
    ...
    offer_ids = fields.One2many('offer.model', 'property_id', string="Property")
