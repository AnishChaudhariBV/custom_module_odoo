...
class SaleOrder(models.Model):
            ...
            for order in orders:
                for line in order.order_line:
                    ...
                    if product_name in product_sales:
                        ...
                        product_sales[product_name] = {'price': line.price_unit, 'qty': line.product_uom_qty,
                                                       'sales': line.price_subtotal, 'sales_with_tax': line.price_total}
    ...
    def _generate_monthly_report(self):
        ...
        for customer, customer_orders in customer_orders_dict.items():
            ...
            template = self.env.ref('Experiment.email_monthly_sale_report_template')

            # Send the report via email with the attachment to the respective salesperson

            template.send_mail(customer.id, force_send=True, email_values=mail_values)
